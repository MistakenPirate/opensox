...
export default function ExploreFeaturesBrowserMockup({
  ...
  return (
    <div
      className={cn(
        "w-full overflow-hidden rounded-xl border border-[#252525] bg-surface-tertiary",
        className
      )}
    >
      {/* Browser chrome */}
      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden bg-[#0a0a0a]">
        {!showFallback ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 p-6">
            ...
            <div className="absolute right-4 top-4 flex gap-2">
              <div className="h-6 w-16 rounded-md bg-[#252525]" />
              <div className="h-6 w-16 rounded-md bg-[#252525]" />
            </div>
            <div className="absolute bottom-4 left-4 right-4 flex gap-3">
              <div className="h-20 flex-1 rounded-lg border border-[#252525] bg-surface-elevated/50" />
              <div className="h-20 flex-1 rounded-lg border border-[#252525] bg-surface-elevated/50" />
              <div className="h-20 flex-1 rounded-lg border border-[#252525] bg-surface-elevated/50" />
            </div>
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#101010]/40 via-transparent to-transparent" />
      </div>
    </div>
  );
}
